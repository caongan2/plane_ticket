...
<div class="wrapper">
    @if(session()->has('login_error'))
        <p class="form-control text-danger screen-mobile" style="background: #ecf0f3; color: red; text-align: center">Sai tài khoản hoặc mật khẩu</p>
    @endif
    ...
    <form class="p-3 mt-3" method="post" action="{{route('login_page')}}">
        @csrf
        <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input type="text" name="login_id" id="userName" placeholder="Username"> </div>
